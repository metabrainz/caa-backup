...
def test_verifier_ignores_non_matching_files(setup):
    """Files that don't match the expected naming pattern are ignored."""
    ds, images_dir, db_path = setup
...
def test_verifier_handles_multiple_extensions(setup):
    """Verifier correctly identifies caa_id regardless of file extension."""
    ds, images_dir, db_path = setup
